...
Exp = importdata([expdir,'Sandia_Helium_Plume_dataplot_inputs.csv']);
...
for i=2:n_plots
    ...
    if dtest % dtest_if (else just skip line)
        ...
        if strcmp(Exp_Plot_Type,'linear')
            ...
            Marker_Edge_Color = 'k';
            Marker_Face_Color = 'k';
            H(1)=plot(X1(1:5:end),Y1(1:5:end),Exp_Plot_Style,'MarkerSize',Marker_Size, ...
